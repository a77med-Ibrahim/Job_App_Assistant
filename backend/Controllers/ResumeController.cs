...
//                 using var httpClient = _httpClientFactory.CreateClient();
//                 var response = await httpClient.PostAsync(
//                 $"https://generativelanguage.googleapis.com/v1beta/models/gemini-1:generateText?key={apiKey}",
//                 content);
...
//                 var ShortResume = document.RootElement
//                 .GetProperty("candidates")[0]
//                 .GetProperty("content")
//                 .GetString();

//                 return ShortResume ?? string.Empty;
//             }
//             catch (Exception ex)
//             {
